...
function comprar()
{
  window.open("carrinho.php?nome=" +document.getElementById("nome").innerHTML+"&preco="+document.getElementById("preco").innerHTML+"&carrinho="+document.getelementByID("carrinho").innerHTML+"&imagem="+"images/armacao3.jpg", "_self");
}
</script>